...
export default function Home() {
    ...
    return (
        ...
        >
            <h1 className="text-4xl xl:text-7xl mb-4">
                Hi I am <span className="color-change font-bold">Jayson</span>
                <span className="emoji inline-block">🤗</span>
            </h1>
            <h3 className="px-5 text-lg lg:text-2xl text-center 2xl:px-0">
                A full-stack web developer from the Philippines. 💻
            </h3>
            <Link
                to="about"
                spy={true}
            ...
            >
                <span className="text-lg group-hover:border-b-2">
                    Learn more about me
                </span>
